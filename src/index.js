...
var OpenWidgets = /** @class */ (function () {
  ...
  OpenWidgets.prototype.renderCustomWidget = function (_a) {
    ...
    var positionWidget = this.coreWidgets.find(function (coreWidget) {
      return coreWidget.id === positionId;
    });
    if (!positionWidget) {
      // tslint:disable-next-line:no-console
  ...
  OpenWidgets.prototype.setupCustomElement = function (_a) {
    var customElement = _a.customElement,
      customWidget = _a.customWidget;
    customElement.user = {
    ...
    customElement.api = {
      ...
      scanQRCode: function () {
        return new Promise(function (resolve) {
          return resolve('https://changers.com');
        });
      },
    };
  };
  OpenWidgets.prototype.setupCoreWidgets = function () {
    ...
    this.coreWidgets.forEach(function (widget) {
      var _a = _this.getWidgetCard(widget),
        el = _a.el,
